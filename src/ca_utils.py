...
def create_initial_info():
    ...
    brazil = CATeam(name='Brazil', info='http://www.ca2011.com/selecoes_resumo.php?idS=c4ca4238a0b923820dcc509a6f75849b', group=group_b, classification_info=classification_info_brazil)
    brazil.put()
